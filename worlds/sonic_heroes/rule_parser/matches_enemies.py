...
PARSER_ENEMY_MAPPING: dict[str, Callable[[Team, Stage], str]] = \
{
    ...
    "KillEggPawnNothingBobsled": lambda team, stage: get_func_str(func_name="can_kill_egg_pawn_with_bobsled", params={"team": team, "stage": stage, "pawn": EggPawn(team=team, stage=stage, weapon=EggPawnWeapon.NO_WEAPON, shield=EggPawnShield.NO_SHIELD, special_type=EggPawnType.REGULAR_PAWN, height=EnemyHeight.JUMP)}),
    "KillEggPawnNothingSHFirstBobsled": lambda team, stage: get_func_str(func_name="can_kill_egg_pawn_with_seaside_hill_first_bobsled", params={"team": team, "stage": stage, "pawn": EggPawn(team=team, stage=stage, weapon=EggPawnWeapon.NO_WEAPON, shield=EggPawnShield.NO_SHIELD, special_type=EggPawnType.REGULAR_PAWN, height=EnemyHeight.JUMP)}),
