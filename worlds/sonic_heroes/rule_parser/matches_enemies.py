...
PARSER_ENEMY_MAPPING: dict[str, Callable[[Team, Stage], str]] = \
{
    ...
    "GreenShot": lambda team, stage: get_func_str(func_name="has_enemy_obj", params={"team": team, "stage": stage, "enemy": EggFlapper(team=team, stage=stage, armor=EggFlapperArmor.NO_ARMOR, weapon=EggFlapperWeapon.SHOT)}),
    "KillGreenShotJump": lambda team, stage: get_func_str(func_name="can_kill_egg_flapper", params={"team": team, "stage": stage, "flapper": EggFlapper(team=team, stage=stage, armor=EggFlapperArmor.NO_ARMOR, weapon=EggFlapperWeapon.SHOT, height=EnemyHeight.JUMP)}),
}